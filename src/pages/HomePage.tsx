...
const lessonTypes = {
  ski: {
    label: '스키',
    steps: [
      ['기본자세', '알파인베이직포지션', '스키의 기본 자세인 알파인 베이직 포지션을 배웁니다.'],
      ['A자', '스노우플라우턴', 'A자 자세에서 방향을 바꾸며 턴의 감각을 만듭니다.'],
      ['S자', '페러렐턴', '두 스키를 나란히 모아 자연스럽게 슬로프를 내려옵니다.'],
    ],
  },
  snowboard: {
    label: '스노보드',
    steps: [
      ['기본자세', 'BBP', '스노보드의 기본 자세인 BBP를 배웁니다.'],
      ['낙엽', '팬듈럼', '발뒤꿈치와 발끝 엣지를 사용해 속도를 조절합니다.'],
      ['턴', '턴 연결', '양쪽 엣지를 전환해 부드러운 턴을 완성합니다.'],
    ],
  },
} as const
