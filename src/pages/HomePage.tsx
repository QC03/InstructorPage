...
const lessonTypes = {
  ski: {
    label: '스키',
    steps: [
      ['A자', '스노우플라우턴', '스키의 기본 자세와 멈추는 방법을 익힙니다.'],
      ['A-S자', '스템턴', 'A자 자세에서 방향을 바꾸며 턴의 감각을 만듭니다.'],
  ...
  snowboard: {
    label: '스노보드',
    steps: [
      ['01', '기본 자세', '시선과 무게 중심을 잡고 안전하게 이동합니다.'],
      ['02', '힐·토 엣지', '발뒤꿈치와 발끝 엣지를 사용해 속도를 조절합니다.'],
      ['03', '턴 연결', '양쪽 엣지를 이어 부드러운 턴을 완성합니다.'],
    ],
  },
} as const
