...
export function HomePage() {
  return <>
    ...
    <section className="intro-band page-width">
      <SectionIntro eyebrow="01 / 수업 방식" title={<>실력보다 먼저, <span>움직임의 이유를</span> 찾습니다.</>} copy="눈 위에서 편안해지는 순간은 각자 다릅니다. 지금의 몸을 정확히 관찰하고, 다음 한 걸음을 함께 설계합니다." />
    ...
    <section className="dark-band">
      <div className="page-width split-heading"><SectionIntro eyebrow="02 / 설원에서" title={<>수업은 사진보다 더 많은 것을 남깁니다.</>} /><Link className="text-link light-link" to="/career">강습 기록 보기 <ArrowUpRight size={16} /></Link></div>
      <Gallery items={siteContent.lessonImages} className="page-width" />
    </section>
    <section className="cta-band page-width"><div><p className="eyebrow">준비되셨다면</p><h2>이번 겨울, <em>눈 위에서 만나요.</em></h2></div><Link className="button button-signal" to="/contact">레슨 문의하기 <ArrowUpRight size={17} /></Link></section>
  </>
}